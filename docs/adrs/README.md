...
| # | Título | Estado |
|---|--------|--------|
| 001 | [Arquitectura de Microservicios](ADR-001-microservices.md) | Aceptado |
| 002 | [Persistencia Poliglota](ADR-002-polyglot-persistence.md) | Aceptado |
| 003 | [Comunicación Asíncrona con RabbitMQ](ADR-003-async-events-rabbitmq.md) | Aceptado |
| 004 | [Patrón Outbox para eventos críticos](ADR-004-outbox-pattern.md) | Aceptado |
